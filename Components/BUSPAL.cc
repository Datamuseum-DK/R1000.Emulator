// Generated from ../_Firmware/BUSGAL-01.BIN by gal_to_systemc.py
#include <systemc.h>
...
SCM_BUSPAL :: SCM_BUSPAL(sc_module_name nm, const char *arg)
{
	SC_METHOD(doit);
	sensitive << pin1.pos();
...
SCM_BUSPAL :: doit(void)
{
	...
	if (pin1.posedge()) {
		out23 =
		    ...
		    ((!p07) && p08);
		out22 =
		    (p02 && (!p03) && p04 && (!p05) && (!p06) && p07 && (!p08) && p09 && (!p10) && (!p13)) ||
		    ((!p02) && p03 && p04 && p05 && (!p06) && (!p07) && (!p08) && (!p09) && p10) ||
		    (p07 && (!p08) && (!p09) && (!p10)) ||
		    ((!p07) && p08) ||
		    ((!p07) && (!p08) && p09 && (!p10));
		...
		out20 =
		    ...
		    ((!p07) && p08 && p09));
		out19 =
		    !((p02 && (!p03) && p04 && (!p06) && (!p07) && (!p08) && (!p09) && p10 && (!p11)) ||
		    (p02 && p03 && p05 && (!p06) && (!p07) && (!p08) && (!p09) && p10) ||
		    ((!p02) && p03 && p04 && p05 && (!p06) && (!p07) && (!p08) && (!p09) && p10) ||
		    ((!p07) && (!p08) && (!p09) && (!p10)) ||
		    ((!p07) && p08) ||
		    ((!p07) && (!p08) && p09));
		...
		out17 =
		    (p02 && (!p03) && p04 && (!p05) && (!p06) && (!p07) && (!p08) && (!p09) && p10 && p13) ||
		    (p02 && (!p03) && p04 && (!p05) && (!p06) && p07 && (!p08) && p09 && (!p10) && p13) ||
		    ((!p02) && p03 && p04 && (!p06) && (!p07) && (!p08) && (!p09) && p10 && p13) ||
		    (p07 && (!p08) && (!p09) && (!p10)) ||
		    ((!p07) && p08) ||
		    ((!p07) && (!p08) && p09 && (!p10));
		out16 =

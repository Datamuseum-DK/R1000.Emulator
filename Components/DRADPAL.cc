// Generated from on ../_Firmware/DRADGAL-01.BIN
#include <systemc.h>
#include "r1000sc.h"
#include "context.h"
#include "DRADPAL.hh"
...
SCM_DRADPAL :: doit(void)
{
	...
	if (pin1.posedge()) {
		dotrace = true;
		state->p23 =
		    !(((!p04) && (!p05) && (!p06) && p03 && p07 && p14 && p15 && p16 && p17) ||
		    ((!p02) && (!p03) && (!p05) && (!p06) && p07 && p14 && p15 && p16 && p17));
		state->p22 =
		    ((!p07));
		state->p21 =
		    !((p05 && p11) ||
		...
		state->p19 =
		    ...
		    ((!p05) && (!p07) && (!p19) && (!p22)) ||
		    ((!p05) && p06 && p07 && p10) ||
		    ((!p05) && (!p07) && (!p23) && p15 && p17 && p22) ||
		    ((!p05) && (!p06) && (!p16) && p07 && p15 && p17) ||
		    ((!p05) && (!p06) && (!p14) && p07 && p15 && p17) ||
		    ((!p05) && (!p06) && p07 && p08 && p15 && p17) ||
		    ((!p04) && (!p05) && (!p06) && p03 && p07 && p15 && p17) ||
		    ((!p02) && (!p03) && (!p05) && (!p06) && p07 && p15 && p17));
		state->p18 =
		    !((p05 && p13) ||
		    ((!p05) && (!p07) && (!p19) && p23) ||
		    ((!p05) && (!p07) && (!p19) && (!p22)) ||

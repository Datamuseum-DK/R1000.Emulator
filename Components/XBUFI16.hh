#ifndef R1000_XBUFI16
#define R1000_XBUFI16
...
SC_MODULE(SCM_XBUFI16)
{
	...
	SC_HAS_PROCESS(SCM_XBUFI16);

	SCM_XBUFI16(sc_module_name nm, const char *arg);

	private:
	struct scm_xbufi16_state *state;
	void doit(void);
};

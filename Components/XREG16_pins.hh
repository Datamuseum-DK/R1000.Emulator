...
#define XREG16_PIN_I1 pin6
#define XREG16_PIN_Y1 pin7
#define XREG16_PIN_I2 pin8
#define XREG16_PIN_Y2 pin9
#define XREG16_PIN_I3 pin10
#define XREG16_PIN_Y3 pin11
#define XREG16_PIN_I4 pin12
#define XREG16_PIN_Y4 pin13
#define XREG16_PIN_I5 pin14
#define XREG16_PIN_Y5 pin15
#define XREG16_PIN_I6 pin16
#define XREG16_PIN_Y6 pin17
#define XREG16_PIN_I7 pin18
#define XREG16_PIN_Y7 pin19
#define XREG16_PIN_I8 pin20
#define XREG16_PIN_Y8 pin21
#define XREG16_PIN_I9 pin22
#define XREG16_PIN_Y9 pin23
#define XREG16_PIN_I10 pin24
#define XREG16_PIN_Y10 pin25
#define XREG16_PIN_I11 pin26
#define XREG16_PIN_Y11 pin27
#define XREG16_PIN_I12 pin28
#define XREG16_PIN_Y12 pin29
#define XREG16_PIN_I13 pin30
#define XREG16_PIN_Y13 pin31
#define XREG16_PIN_I14 pin32
#define XREG16_PIN_Y14 pin33
#define XREG16_PIN_I15 pin34
#define XREG16_PIN_Y15 pin35
#define XREG16_PIN_I16 pin36
#define XREG16_PIN_Y16 pin37
#ifdef ANON_PINS
    ...
    #define PIN_I16 XREG16_PIN_I16
    #define PIN_Y16 XREG16_PIN_Y16
#endif
...
#define PIN_PAIRS(macro) \
	macro(15, PIN_I1, PIN_Y1) \
	macro(14, PIN_I2, PIN_Y2) \
	macro(13, PIN_I3, PIN_Y3) \
	macro(12, PIN_I4, PIN_Y4) \
	macro(11, PIN_I5, PIN_Y5) \
	macro(10, PIN_I6, PIN_Y6) \
	macro(9, PIN_I7, PIN_Y7) \
	macro(8, PIN_I8, PIN_Y8) \
	macro(7, PIN_I9, PIN_Y9) \
	macro(6, PIN_I10, PIN_Y10) \
	macro(5, PIN_I11, PIN_Y11) \
	macro(4, PIN_I12, PIN_Y12) \
	macro(3, PIN_I13, PIN_Y13) \
	macro(2, PIN_I14, PIN_Y14) \
	macro(1, PIN_I15, PIN_Y15) \
	macro(0, PIN_I16, PIN_Y16)
#endif

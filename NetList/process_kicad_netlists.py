...
class Board():
    ...
    def filename(self, suffix):
        ...
        return self.name + "/" + self.name.lower() + suffix
...
def main():
    ...
    DIR = "/critter/R1K/R1000.HwDoc/main/Schematics"
    for boardname in ("MEM32", "IOC", "FIU", "TYP", "VAL", "SEQ"):
        board = Board(DIR + "/" + boardname + "/" + boardname + ".net")
        board.produce()

/* Machine-generated, see /home/phk/Proj/R1000.Emulator/Iop/make_pascal_syscalls.py */
	...
	{ 0x1023c, "`KC1e_Fifo_Tx_Response",
	    "sp+3 'ptr=' @L .L , sp+2 'chan=' @W .W",
	    "",
	},
	{ 0x1023e, "`KC1f_Fifo_Rx_Request",
	    "sp+5 'ptr=' @L .L , sp+4 'chan=' @W .W , '!' sp+2 @L 'flag=' @B .B",
	    "sp+0 @L 'flag=' @B .B",
	},
	{ 0x10240, "`KC20_Estop",
	    "",
	...
	{ 0x102c4, "`MakeString",
	    "sp+4 'a=' @L .L , sp+3 'b=' @W .W , sp+2 'len=' @W .W",
	    "'>' sp+4 String",
	},
	{ 0x102c8, "`StringEqual",
	...
	{ 0x104a8, "`?FS104a8",
	    "sp+12 'VAR=' @L .L , sp+10 'b=' @L .L , sp+8 'c=' @L .L , sp+6 'VAR=' @L .L , sp+4 'e=' @L .L , sp+2 'f=' @L .L",
	    "'>' sp+12 @B .B",
	},
	{ 0x104b4, "`?FS104b4",
	...
	{ 0x104fc, "`IPC_PutVar",
	    "sp+6 'src=' @L .L , sp+4 'length=' @L .L , sp+2 'type=' @L .L",
	    "",
	},
	{ 0x10502, "`IPC_PutBool",
	    "sp+2 'a=' @B .B",
	...
	{ 0x10520, "`IPC_GetVar",
	    "sp+6 'dst=' @L .L , sp+4 'length=' @L .L , sp+2 'type=' @L .L",
	    "sp+4 'dst=' @L .L",
	},
	{ 0x10526, "`IPC_GetBool",
	    "",
	...
	{ 0x10556, "`?IPC_GetStd",
	    "sp+6 'a=' @L .L , '!' sp+4 @L 'b=' @B .B , '!' sp+2 @L 'c=' @B .B",
	    "sp+4 'a=' @L .L , sp+2 @L 'b=' @B .B , sp+0 @L 'c=' @B .B",
	},
